...
# bigger axis labels
plottedGenos <- plottedGenos + theme(axis.text = element_text(size = 14),
...
Another way to compare the outcome of imputation is to produce graphical genotypes of both datasets using the plotGenos() function. Here only the first chromosome is shown.
...
```{r, fig.show = 'hold', fig.width = 7, fig.height = 7, fig.cap = "Fig. 4: Marker Density"}
...
```{r, fig.show = 'hold', fig.width = 7, fig.height = 7, fig.cap = "Fig. 5:Parental allele frequencies"}
